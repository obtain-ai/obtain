...
<div class="flex flex-col w-full border border-zinc-200 rounded-lg bg-zinc-700 shadow-lg overflow-hidden">  <div class="flex justify-between items-center p-3 border-b border-zinc-600 bg-zinc-800">
